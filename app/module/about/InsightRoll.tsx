...
const InsightRoll = () => {
    ...
    const insights = [
        ...
        'Your fantastic ideas + my pactical skills = realities.',
    ...
    return (
        <div className="w-full logo mt-4 text-white whitespace-nowrap absolute border-b-2 border-white top-16 overflow-hidden ">
            <div className="animate-roll py-6 flex justify-center items-center w-full font-semibold tracking-wider text-base">
                {
                    insights.map((item, i) =>(
