...
const Hero = () => {
  return (
    <div className="relative overflow-hidden min-w-full h-[550px] sm:h-[650px] lg:h-[550px] bg-white/80 rounded-sm shadow">
      <img src="/images/d-man.png" alt="Ademola" width={200} height={320} className="absolute top-0 left-0 rounded w-full h-full"/>
      <div className="relative mb-[1rem] mt-[20rem] sm:mt-[25rem] grid gap-4">
        <div className="hero-text-container grid lg:hidden">
          <p className="hero-text-name text-black">Ademola Adeniji</p>
          <p className="hero-text-position">Web App Developer</p>
        </div>
